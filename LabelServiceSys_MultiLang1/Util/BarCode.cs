...
namespace Util
{
    public class Code128
    {
        ...
        private Bitmap GetImage(string p_Text)
        {
            ...
            //Bitmap _CodeImage = new Bitmap(200, (int)40);
        ...
        private void GetViewText(Bitmap p_Bitmap, string p_ViewText)
        {
            ...
            SizeF _DrawSize = _Graphics.MeasureString(p_ViewText.Substring(3), m_ValueFont);//去掉前面的#2#
            ...
            int _StarX = p_Bitmap.Width / 2 - (int)_DrawSize.Width/2;
            _Graphics.FillRectangle(Brushes.White, new Rectangle(0, _StarY, p_Bitmap.Width, (int)_DrawSize.Height));
            _Graphics.DrawString(p_ViewText.Substring(3), m_ValueFont, Brushes.Black, _StarX, _StarY);
        }
